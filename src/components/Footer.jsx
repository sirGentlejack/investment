    ...
    <div className="d-md-flex justify-content-around p-5 bg-body">
      ...
      <div>
        ...
        <div className="d-flex justify-content-around">
          <svg style={{width:"50px", cusor:"pointer"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <svg style={{width:"50px"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            {/* <!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--> */}
